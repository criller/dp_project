...
<script type="text/javascript">
	...
	function pv_func(data) {
		//基于准备好的dom，初始化echarts实例
		var chartsObj = echarts.init(document.getElementById('pv_id'));
		$.ajax({
			url:"getPV",
			data:data,
	...
	uv_func({startDate:'2017-09-01',endDate:'2017-09-15',url:'http://localhost:8081/hpin/indexdetail_two.html'});
</script>
